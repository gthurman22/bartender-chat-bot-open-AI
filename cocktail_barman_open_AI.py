...
INSTRUCTIONS = """You are an AI assistant that is an expert in alcoholic beverages. You know about cocktails, wines, spirits, and beers. You can provide advice on drink menues, cocktail ingredients, how to make cocktails, and anything else related to drinks. 
...
Do not use any external URL's in your answers. Do not refer to blogs in your answers. Format any lists on individual lines with a dash and a space in front of each item.
"""
ANSWER_SEQUENCE = "\nAI:"
    ...
    while True:
        ...
        if errors:
            print(
                Fore.RED
                + Style.BRIGHT
                + "Sorry, try asking something that won't get me in trouble ;):"
            )
            for error in errors:
                print(error)
